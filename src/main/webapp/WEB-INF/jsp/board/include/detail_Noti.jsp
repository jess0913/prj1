					...
					<div class="box">
						<div class="box-body">
							<table class="table table-bordered table-striped dataTable">
								<thead>
									<tr>
										<th class="col-xs-3" style="text-align: center;">${notiMap.title }</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>${notiMap.description }</td>
									</tr>
								</tbody>
							</table>
						</div>				
						...
						<div class="box-footer">
							<div class="row" style="height: 34px; line-height: 34px; text-align: center;">
								<button type="button" class="btn btn-default btn-flat" id="list" >목록</button>
							</div>
						</div>
						<!-- button -->
					</div>
